...
# We can do some manipulation to the field names so they are easier to read
...
# Do some manipulation to the fields to they are easier to read, 
# group by field and year and find the total awarded by field, then sort and rank them
phd_ranks <- phd_field %>% 
